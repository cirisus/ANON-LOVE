...
@keyframes leftIn {from {transform: translate(-50%, -75%);} to {transform: translate(-175%,-75%);}}
@keyframes fade {from {opacity: 1;} to {opacity: 0;}}
@keyframes blurBold {from {filter: blur(1rem);} to {filter: blur(0);}}
@keyframes blurThin {from {filter: blur(2px);} to {filter: blur(0);}}
    #loader, #open-effects {
        position: fixed;
        left: 0;
        top: 0;
    ...
    .progress-bar-container {
        ...
        animation: cutProgressBar .3s cubic-bezier(.4,0,.6,1) 2.5s 1 forwards,blurThin .3s cubic-bezier(.4,0,.6,1) 2.5s 1 reverse forwards;
       > .progress-bar {
            height: 100%;
            position: relative;
        ...
        > .progress-text {
            ...
            animation: leftIn .3s ease 2.5s 1 forwards, fade .3s ease 2.5s 1 forwards, blurBold .3s ease 2.5s 1 reverse forwards;
        }
    }
    .anon-signature {
        position: fixed;
