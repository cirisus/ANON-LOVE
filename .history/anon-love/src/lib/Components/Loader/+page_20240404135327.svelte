...
@keyframes blurThin {from {filter: blur(0);} to {filter: blur(2px);}}
    #loader, #open-effects {
        position: fixed;
        left: 0;
        top: 0;
    ...
    .progress-bar-container {
       ...
       > .progress-bar {
        ...
        > .progress-text {
            ...
            animation: leftInText .3s ease 2s 1 forwards, fade .3s ease 2.5s 1 forwards, blurBold .3s ease 2s 1 forwards;
        }
    }
    .anon-signature {
        position: fixed;
    ...
    .anon-sprite {
        ...
        background-size: contain;
        animation: leftInSprite .4s cubic-bezier(.4,0,.6,1) 2s 1 forwards, fade .4s cubic-bezier(.4,0,.6,1) 2.5s 1 reverse forwards, blurThin .4s cubic-bezier(.4,0,.6,1) 2.25s 1 forwards;
    }
</style>