export function updateProgress(newProgress, callback) {
    ...
    function incrementProgress() {
        ...
        progressBars.forEach(progressBar => {
            progressBar.style.clipPath = `polygon(${currentProgress}% 0, 0 0, 0 100%, ${currentProgress}% 100%)`;
            progressBar.style.webkitClipPath = `polygon(${currentProgress}% 0, 0 0, 0 100%, ${currentProgress}% 100%)`;
        });
