...
<footer>
	<span class="footer">©2024 ANON-LOVE|<a on:click={() => showModal = !showModal}>CONTENT USAGE SPECIFICATIONS</a></span>
	<Modal {title} {buttonText} {showModal} on:modalToggle={handleModalToggle}>
