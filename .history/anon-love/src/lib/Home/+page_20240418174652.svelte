	...
	<Scroller slots=5>
		...
		<div slot="scrollbox-2" data-toggle="hide">
			<Emerger className="about">
				<h1>Home</h1>
				<p>
					Welcome to my website! I'm Cirisus, a web developer and a fan of Bang Dream! I'm currently working on this website to showcase my works and to share my love for Bang Dream! I hope you enjoy your stay here!
				</p>
			</Emerger>
		</div>
